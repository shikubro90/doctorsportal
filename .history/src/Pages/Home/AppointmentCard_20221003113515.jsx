...
const AppointmentCard = (props) => {
  ...
  return (
    <section className={``} style={{background: `url(${style})`, marginTop : "80px"}}>
      <div className={`wrapper lg:flex items-center px-52 ${style}`}>
        <div className="image flex-1">
          <img className={`rounded-lg ${style && "mt-[-60px]"}`} src={image} alt="bannerImage" />
        </div>
