      ...
      <div className="container flex flex-col items-center justify-center">
        ...
        <div className="bodyPart flex flex-col items-center justify-center">
          <form action="" className="flex flex-col items-center justify-center">
            <input className='w-[450px] rounded-md outline-none text-accent font-semibold px-5 py-4 mb-1' type="email" placeholder="Email Address" />
            <input className='w-[450px] rounded-md outline-none text-accent font-semibold px-5 py-4' type="text" placeholder="subject" />
