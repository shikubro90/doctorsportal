    ...
    <div className="card md:max-w-2xl bg-base-100 text-primary-content shadow-xl">
      <div className="card-body items-center">
        ...
        <div className="card-actions justify-end">
          <lab htmlFor="my-modal-3" disabled={slots.length === 0} onClick={()=>{setTreatment(services)}} className="btn btn-sm btn-secondary uppercase text-white">Book Appointment</button>
        </div>
      </div>
    </div>
  )
